          ...
          <div className='w-[100%] flex justify-center lg:justify-center px-2 '>
           ...
           '>Aspring Web Developer</h1>
            ...
            <div className=' lg:flex block lg:justify-center w-[auto] lg:gap-5 lg:w-full lg:h-full mt-10 mb-10 mx-1'>
                <div className='bg-slate-200  bg-opacity-80 rounded-tr-full rounded-tl-full
                rounded-br-full p-2 lg:h-[500px] h-[100%] mb-5 rounded-xl'>
                <img src={ProfilePic} className='w-[100%] h-[300px] rounded-bl-full rounded-tl-full rounded-br-full
            ...
            rounded-tr-3xl p-2 h-[100%] lg:h-[500px] shadow-xl
            pb-10 lg:w-[500px] lg:p-5'>
                <h1 className='text-white font-semibold text-2xl mt-5 mx-5'>Hello, I'am </h1>
                <h1 className='text-slate-200 text-4xl mb-4 mx-5 font-bold
