...
import ProfilePic from '../assets/vinzzz.jpg';
...
const LandingPage = () => {
  ...
  return (
    <div id="homepage" className=" bg-no-repeat bg-cover
     ...
     bg-gradient-to-r from-stone-300 to-slate-200">
        <main className='mt-16 mx-5 w-[100%] lg:w-100%'>
          <div className='w-[100%] flex justify-center lg:justify-center px-2'>
           
              <h1 className='lg:text-4xl  text-2xl mt-5 text-black font-bold text-center'>IT | Web Developer</h1>
            </div>
            <h1 className='text-sm lg:text-lg mt-2 text-black text-center block'>
            ...
            <div className='flex-row-reverse lg:flex block lg:justify-center lg:gap-5 lg:w-full lg:h-full mt-10 mb-10 mx-1'>
                <div className='bg-slate-200  bg-opacity-10
                  w-[auto] p-2 lg:h-[500px] h-[100%] mb-5 rounded-xl '>
                <img src={ProfilePic} alt="" className='w-[100%] h-[300px] rounded-lg
            ...
            pb-10 lg:w-[50%] lg:p-5'>
                <h1 className='text-slate-600 font-semibold text-5xl mt-5 mx-5'>Hello, I am </h1>
                <h1 className='text-slate-600 text-2xl lg:text-4xl mb-4 mx-5 font-bold
                animate-typing overflow-hidden whitespace-nowrap'>Vincent
                <span className='text-sky-500'> San Pedro</span></h1>
                <div className='mx-5'>
                <h2 className='text-slate-600 font-bold italic'>Welcome to my portfolio, i am a web developer
