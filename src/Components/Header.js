...
const Header = () => {
  ...
  return (
    <div className='shadow-xl'>
        ...
        lg:justify-evenly w-[100vw] px-5 text-white h-[68px]
        z-10 bg-${color ? "slate-950" : "none"}`}>
            ...
            md:gap-10 lg:gap-10 lg:flex -ml-5 transition-all duration-300 ease-in
             ${open ? 'top-[-12px]' : 'top-[-500px]'} text-sm  cursor-pointer  `}>
                ...
                duration={500} className='hover:text-yellow-300 hover:text-lg
            ...
            <a href="tel: +639217490083"
             className='bg-yellow-300 px-2 flex lg:block
             justify-center  py-1 rounded-md text-sm font-mono space-x-[-1px]
